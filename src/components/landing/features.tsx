  ...
  return (
    <div className="py-24 bg-background relative overflow-hidden" id="features">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="bg-blue-50 dark:bg-neutral-900 absolute -top-1/2 -right-1/5 w-1/2 h-1/2 rounded-full"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 45, 0],
          }}
        ...
        />
        <motion.div
          className="bg-blue-50 dark:bg-neutral-900 absolute -bottom-1/2 -left-1/4 w-1/2 h-1/2 rounded-full"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, -45, 0],
          }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="lg:text-center">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Our comprehensive suite of Salesforce services is designed to support your business at every stage of your Salesforce journey.
          </motion.p>
        </div>
